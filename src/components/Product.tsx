    ...
    <div  id="product_items" className="grid__row">
      {products.map(item=>
        (
            ...
            <div className="product-item_img" style={{backgroundImage: `url(${item.image})`}}></div>
            <h4 className="product-item_name">${item.name}</h4>
            <div className="product-item_price">${item.price}</div>
            <div className="product-item_action">
                <span className="product-item_like">
                    <i className="far fa-heart"></i>
                </span>
                <span className="product-item_sold">${item.sold} đã bán</span>
            </div>
            <div className="product-item_origin">
                <span className="product-item_brand">${item.brand}</span>
                <span className="product-item_place">${item.place}</span>
            </div>
            </a>
        </div>
        )
